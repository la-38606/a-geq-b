...
\smallskip
The unit suites complement the corpus with $139$ cases: algebraic laws and
canonicalisation, the parser (including denominator clearing and rejection of
malformed input), the checker against adversarial certificates (negative
